...
module ModularTitle
  ...
  #-------------------------------------------------------------------------------
    ...
    # Ocean Breeze
    #"background11", "intro:1", "logoY:172", "logo:sparkle", "logo:shine", "overlay:blue_z25", "misc5:blastoise_x294_y118", "effect5_y106", "effect4_y106", "bgm:T - PKMNCS - The darkest crisis"

    # Evolution
    #"background8", "effect7_y272", "effect6_y272", "effect4_y272", "effect5_y272", "logoY:172", "misc4_y312", "overlay5", "bgm:T - PKMNCS - The darkest crisis", "intro:3"

    # Burning Red (gen 1)
    #"background:frlg", "intro:1", "effect10_y308", "overlay:frlg", "logoX:204", "logoY:164", "logo:sparkle", "misc5:charizard_x284_y142", "bgm:T - PKMNCS - The darkest crisis"

    # Heart of Gold (gen 2)
    #"background:dawn", "intro:2", "logoY:172", "logo:glow", "misc2", "effect11_x368_y112", "effect6_x368_y112", "effect4_x368_y112", "overlay3", "bgm:T - PKMNCS - The darkest crisis"

    # Sapphire Abyss (gen 3)
    #"background:rse", "intro:3", "misc3_x260_y236", "overlay4", "logoY:172", "logo:sparkle", "logo:shine", "effect3_y236", "bgm:T - PKMNCS - The darkest crisis"

    # Platinum Shade (gen 4)
    #"background10", "intro:4", "overlay7", "bgm:T - PKMNCS - The darkest crisis", "logoY:172"

    # Dark Display (gen 5)
    #"background:bw", "overlay2", "logoY:172", "logo:shine", "misc4_s2_x284_y339", "effect6_y312", "bgm:T - PKMNCS - The darkest crisis"

    # Forest Sky (gen 6) "The best???"
    #"background4", "intro:6", "effect4", "effect5", "effect7", "overlay:static002", "bgm:T - PKMNCS - The darkest crisis"

    # Cosmic Vibes (gen 7)
    #"background3", "intro:7", "effect5", "effect6", "overlay6", "logo:shine", "bgm:T - PKMNCS - The darkest crisis"
  #-------------------------------------------------------------------------------
  #                  V V     add your modifiers in here     V V
  #-------------------------------------------------------------------------------
  #new
    #PKMN: CRYSTAL STONE - Until...
    #"background2", "effect1", "effect4","effect5", "overlay:static004","overlay:static003", "logo:shine", "intro:2" ,"bgm:T - PKMNCS - Until..."

    #PKMN: CRYSTAL STONE - The darkest crisis
    "background:the astrial trios", "intro:6", "effect4", "effect1", "effect5", "bgm:T - PKMNCS - The darkest crisis", "logo:sparkle", "logo:glow","logo:shine", "effect3", "overlay:static004", "overlay:static003", "overlay:static002"
